...
RSpec.describe Gitlab::Llm::Chain::Tools::WorkItemReader::Prompts::Anthropic, feature_category: :duo_chat do
  let(:options) do
    {
      input: 'foo?',
  ...
  def system_prompt
    ::Gitlab::Llm::Chain::Tools::WorkItemReader::Executor::SYSTEM_PROMPT[1]
  end
end
