...
RSpec.describe 'Container-Scanning.latest.gitlab-ci.yml', feature_category: :container_scanning do
  include Ci::PipelineMessageHelpers

  subject(:template) { Gitlab::Template::GitlabCiYmlTemplate.find('Container-Scanning.latest') }
