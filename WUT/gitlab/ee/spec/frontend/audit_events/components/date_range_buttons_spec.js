...
describe('DateRangeButtons component', () => {
  ...
  const findThisMonthButton = () => wrapper.findByTestId('date_range_button_last_30_days');
  ...
  describe('when the last 7 days is selected', () => {
    ...
    describe.each`
      ...
      ${findThisMonthButton}   | ${false} | ${'Last 30 days'} | ${'date_range_button_last_30_days'} | ${getDateInPast(CURRENT_DATE, 30 - SAME_DAY_OFFSET)}
