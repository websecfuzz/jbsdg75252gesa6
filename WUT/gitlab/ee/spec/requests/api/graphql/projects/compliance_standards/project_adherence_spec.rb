...
RSpec.describe 'getting the project compliance standards adherence',
  ...
  let_it_be(:adherence_1) do
    create(:compliance_standards_adherence, :gitlab, project: project,
  ...
  let_it_be(:adherence_4) do
    create(:compliance_standards_adherence, standard: :soc2, project: project,
  ...
  let(:adherence_4_output) do
    get_compliance_standards_adherence_values(adherence_4)
  end

  let(:project_adherence) { graphql_data_at(:project, :compliance_standards_adherence, :nodes) }
  ...
  def query(params = {})
    graphql_query_for(
      ...
      query_graphql_field("complianceStandardsAdherence", params, fields)
    )
  end
  ...
  context 'when the user is authorized' do
    ...
    context 'without any filters' do
      it 'finds all the project compliance standards adherence for the project' do
        post_graphql(query, current_user: current_user)

        expect(project_adherence).to match_array(
          [adherence_1_output, adherence_4_output]
        )
      end
    end
      ...
      context 'when given a check_name' do
        context 'when the input is valid' do
          it 'finds the filtered project compliance standards adherence' do
            ...
            expect(project_adherence).to match_array([adherence_1_output])
          end
        end
        ...
        context 'when the input is not valid' do
          it 'finds the filtered project compliance standards adherence' do
            ...
            expect_graphql_errors_to_include(
              "Argument 'checkName' on InputObject 'ComplianceStandardsProjectAdherenceInput' has an invalid value")
          end
        end
      end
      ...
      context 'when given a standard' do
        ...
        context 'when the input is not valid' do
          it 'finds the filtered project compliance standards adherence' do
            ...
            expect_graphql_errors_to_include(
              "Argument 'standard' on InputObject 'ComplianceStandardsProjectAdherenceInput' has an invalid value")
          end
        end
      end
    end
