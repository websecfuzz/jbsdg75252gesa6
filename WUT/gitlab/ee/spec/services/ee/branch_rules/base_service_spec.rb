...
RSpec.describe BranchRules::BaseService, feature_category: :source_code_management do
  ...
  describe '#execute' do
    ...
    context 'with skip_authorization: true' do
      ...
      context 'when branch_rule is an instance of Projects::AllProtectedBranchesRule' do
        let(:branch_rule) { Projects::AllProtectedBranchesRule.new(project) }

        it_behaves_like 'missing_method_error', 'execute_on_all_protected_branches_rule'
      end
