...
RSpec.describe ComplianceManagement::Standards::Soc2::AtLeastOneNonAuthorApprovalGroupWorker,
  ...
  describe '#perform' do
    context 'for non existent group' do
      ...
      it 'does not enqueue AtLeastTwoApprovalsWorker' do
        expect(ComplianceManagement::Standards::Soc2::AtLeastOneNonAuthorApprovalWorker).not_to receive(:new)
    ...
    context 'for non existent user' do
      ...
      it 'enqueues AtLeastTwoApprovalsWorker' do
        allow(::ComplianceManagement::Standards::Soc2::AtLeastOneNonAuthorApprovalWorker)
