...
RSpec.describe ComplianceManagement::Standards::Gitlab::DastGroupWorker,
  ...
  describe '#perform' do
    context 'for non existent group' do
      ...
      it 'does not enqueue DastWorker' do
        expect(ComplianceManagement::Standards::Gitlab::DastWorker).not_to receive(:new)
    ...
    context 'for non existent user' do
      ...
      it 'enqueues DastWorker' do
        expect(::ComplianceManagement::Standards::Gitlab::DastWorker)
