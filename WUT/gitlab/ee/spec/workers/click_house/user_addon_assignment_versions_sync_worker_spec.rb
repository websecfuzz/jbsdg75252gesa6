...
RSpec.describe ClickHouse::UserAddonAssignmentVersionsSyncWorker, :click_house, feature_category: :seat_cost_management do
  ...
  context 'when ClickHouse is enabled for analytics' do
    ...
    it 'calls sync service' do
      expect_next_instance_of(::ClickHouse::SyncStrategies::UserAddonAssignmentVersionsSyncStrategy) do |sync_strategy|
