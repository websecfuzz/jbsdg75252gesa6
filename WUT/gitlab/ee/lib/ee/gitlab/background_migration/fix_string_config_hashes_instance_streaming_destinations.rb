...
module EE
  module Gitlab
    module BackgroundMigration
      module FixStringConfigHashesInstanceStreamingDestinations
        extend ActiveSupport::Concern
        extend ::Gitlab::Utils::Override

        prepended do
          operation_name :update_string_configs_hashes_instance_streaming_destinations
        ...
        def bulk_update(updates)
          ...
          connection.execute(<<~SQL)
            ...
            WHERE audit_events_instance_external_streaming_destinations.id = v.id
          SQL
        end
      end
    end
