...
def parse_post_data(post_data):
    ...
    config.logger.info(f"[FUNCTION] Call parse_post_data for {post_data}")
...
if __name__ == "__main__":
    print(parse_post_data("subject=etcigzap&notestitle=xyomgzap&notesdesc=qskuyzap&submit="))
    print(parse_post_data("bug=148&form_bug="))