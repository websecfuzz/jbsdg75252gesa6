...
./sqlifuzz.sh wordpressv682 8081 / api.json evomaster
./sqlifuzz.sh wordpressv682 8081 / api.json schemathesis http://localhost:8888/wp-json
./sqlifuzz.sh casdoor 8081 /login openapi.json evomaster
./sqlifuzz.sh nodebbv451 4567 / read-bundled.yaml evomaster
...
export MAX_CONCURRENT_FUZZ=5 ./sqlifuzz.sh bwapp 8081 / openapi.json bacfuzz
...
./sqlifuzz.sh nodebb 4567 / read-bundled.yaml schemathesis